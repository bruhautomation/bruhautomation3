...
![The brAIn Memory tab: two guesses awaiting a yes/no, three discoveries waiting to be filed, a "Teach it something" box, and the home memory document below with sections on the household, the house, and device quirks](/images/brain/panel-memory.webp)
