...
![The brAIn Findings tab, headed "What brAIn thinks is broken", listing thirteen orphaned entities, two loft sensors that never rejoined after a Zigbee channel change, and a dead back-door battery sensor — each with Fix it, Discuss, I fixed it, Remind me later and Ignore](/images/brain/panel-findings.webp)

Press **Fix it** and Claude makes the change, verifies it, and reports what it touched.
Press **Discuss** to talk it over first, changing nothing. **I fixed it** and **Ignore** are
endings: the answer becomes a fact in memory, and the row is gone for good rather than
joining a pile of dismissed cards.
