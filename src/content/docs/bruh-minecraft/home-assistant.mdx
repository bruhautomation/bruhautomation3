...
**Announce dinner over the server** (paired with a [BRUH Terminal](/bruh-claude/) voice assistant, *"tell everyone dinner's ready"* does this hands-free — no config needed on the Minecraft side):
