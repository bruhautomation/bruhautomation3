...
2. **Install the add-on.** Find **BRUH Minecraft Server** in the store and click **Install** (~600 MB image).
...
3. **Accept the EULA.** Open the **Configuration** tab and set:
   ...
   This acknowledges the [Minecraft EULA](https://www.minecraft.net/eula) — required by Mojang. While you're there, you'll likely want:
