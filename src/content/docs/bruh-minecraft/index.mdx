...
![The BRUH Minecraft panel's Console tab, showing the tab bar — Dashboard, Console, Players, Server Properties, Plugins, Backups, Worlds, Resource Packs — above the live server log and command bar](/images/bruh-minecraft/panel-console.webp)
