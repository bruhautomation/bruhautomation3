...
The add-on ships a built-in **MCP server** that Claude Code launches automatically, giving it live read/write access to your Home Assistant instance. Verify every tool on your install with `ha-selftest`.
