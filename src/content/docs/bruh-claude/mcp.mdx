...
The add-on ships a built-in **MCP server** that Claude Code launches automatically — it's what turns Claude from "a chatbot that read your YAML once" into an operator with live access to your home. Verify every tool on your install with `ha-selftest`.
