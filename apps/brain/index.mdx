...
The panel is one ingress page with seven tabs, built for a phone as seriously as a
...
![The brAIn panel on a phone, showing the two-row top bar with the tabs named beneath the status row](./images/panel-phone.webp)
