		...
		starlight({
			...
			sidebar: [
				...
				},
				{
					...
					collapsed: true,
					items: [
						{ label: '7-Segment Display', slug: 'smart-home-projects/7-segment-display' },
						{ label: 'BLE Hub', slug: 'smart-home-projects/ble-hub' },
						{ label: 'BRUH Playhouse', slug: 'smart-home-projects/bruh-playhouse' },
						{ label: 'Desk Controller', slug: 'smart-home-projects/desk-controller' },
						{ label: 'ESP32-CAM', slug: 'smart-home-projects/esp32-cam' },
						{ label: 'Hype Button', slug: 'smart-home-projects/hype-button' },
						{ label: 'Irrigation System', slug: 'smart-home-projects/irrigation-system' },
						{ label: 'Multisensor', slug: 'smart-home-projects/multisensor' },
						{ label: 'Neopixel Strip', slug: 'smart-home-projects/neopixel-strip' },
						{ label: 'Nextion Touch Panel', slug: 'smart-home-projects/nextion-touch-panel' },
						{ label: 'Nightlight', slug: 'smart-home-projects/nightlight' },
						{ label: 'Smart Blinds', slug: 'smart-home-projects/smart-blinds' },
						{ label: 'Smart Candle', slug: 'smart-home-projects/smart-candlet' },
						{ label: 'Sourdough Monitor', slug: 'smart-home-projects/sourdough-monitor' },
						{ label: 'Sonoff RF Bridge', slug: 'smart-home-projects/sonoff-rf-bridge' },
						{ label: 'Sonoff S20', slug: 'smart-home-projects/sonoff-s20' },
						{ label: 'Sonoff S31', slug: 'smart-home-projects/sonoff-s31' },
						{ label: 'Sound Machine', slug: 'smart-home-projects/sound-machine' },
						{ label: 'UV Sensor', slug: 'smart-home-projects/uv-sensor' },
						{ label: 'Voice Assistant', slug: 'smart-home-projects/voice-assistant' },
					],
				},
				{
					label: 'Home Projects',
