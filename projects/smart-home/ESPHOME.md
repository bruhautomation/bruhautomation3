...
### Sensors
- [`multisensor/bruh-multisensor.yaml`](multisensor/bruh-multisensor.yaml) - ESP8266 room sensor (DHT22, PIR, RGB LED, light level)
- [`multisensor/bruh-multisensor-esp32.yaml`](multisensor/bruh-multisensor-esp32.yaml) - ESP32 variant with BME280, TSL2561, computed sensors
- [`uv-sensor/bruh-uv-sensor.yaml`](uv-sensor/bruh-uv-sensor.yaml) - LTR390 UV index sensor with BME280 and OLED display
- [`7-segment-display/bruh-7-segment-display.yaml`](7-segment-display/bruh-7-segment-display.yaml) - MAX7219 7-segment display for HA data

### Smart Plugs & Switches
- [`sonoff-s31/sonoff-s31.yaml`](sonoff-s31/sonoff-s31.yaml) - Sonoff S31 with real-time power monitoring (CSE7766)
- [`sonoff-s20/sonoff-s20.yaml`](sonoff-s20/sonoff-s20.yaml) - Sonoff S20 basic smart plug
- [`sonoff-rf-bridge/sonoff-rf-bridge.yaml`](sonoff-rf-bridge/sonoff-rf-bridge.yaml) - Sonoff RF Bridge for 433MHz RF codes
- [`hype-button/bruh-switch.yaml`](hype-button/bruh-switch.yaml) - Multi-click button controller with LED feedback

### Lighting
- [`neopixel-strip/bruh-neopixel-strip.yaml`](neopixel-strip/bruh-neopixel-strip.yaml) - ESP8266 addressable RGB LED strip
- [`nightlight/bruh-nightlight.yaml`](nightlight/bruh-nightlight.yaml) - ESP32 simple PWM LED nightlight
- [`nightlight/bruh-nightlight-rgb.yaml`](nightlight/bruh-nightlight-rgb.yaml) - ESP32-S3 RGB LED strip with effects

### Home Automation
- [`smart-candle/bruh-candle.yaml`](smart-candle/bruh-candle.yaml) - Auto-igniting/extinguishing candle with TFT display
- [`desk-controller/bruh-desk.yaml`](desk-controller/bruh-desk.yaml) - Electric desk height controller with custom UART sensor
- [`smart-blinds/bruh_blinds.yaml`](smart-blinds/bruh_blinds.yaml) - Servo-controlled blinds with touch sensor

### Audio & Video
- [`sound-machine/bruh-sound-machine.yaml`](sound-machine/bruh-sound-machine.yaml) - DFPlayer MP3 module audio player
- [`voice-assistant/bruh-voice-assistant.yaml`](voice-assistant/bruh-voice-assistant.yaml) - M5Stack Atom Echo voice assistant
- [`esp32-cam/bruh-esp32-cam.yaml`](esp32-cam/bruh-esp32-cam.yaml) - ESP32-CAM with OLED display and motion detection

### Specialized Controllers
- [`irrigation-system/bruh-pump.yaml`](irrigation-system/bruh-pump.yaml) - Irrigation pump controller with 7 zones, flow sensors, TDS monitoring
- [`irrigation-system/bruh-pump-s3.yaml`](irrigation-system/bruh-pump-s3.yaml) - ESP32-S3 variant of pump controller
- [`ble-hub/bruh-ble-hub.yaml`](ble-hub/bruh-ble-hub.yaml) - Bluetooth LE tracker/proxy hub
- [`sourdough-monitor/bruh-sourdough-monitor.yaml`](sourdough-monitor/bruh-sourdough-monitor.yaml) - Smart jar for fermentation tracking

### Entertainment
- [`playhouse/bruh-playhouse.yaml`](playhouse/bruh-playhouse.yaml) - Complex playhouse controller with servos, DFPlayer, LEDs
- [`playhouse/bruh-playhouse-fan.yaml`](playhouse/bruh-playhouse-fan.yaml) - Playhouse fan speed controller
- [`playhouse/bruh-playhouse-mini.yaml`](playhouse/bruh-playhouse-mini.yaml) - Simplified playhouse controller
...
```bash
cp multisensor/bruh-multisensor.yaml ~/.config/esphome/
```
